...
/// with std::to_underlying or a user-provided equivalent function.
///
/// For the user-facing documentation see:
/// http://clang.llvm.org/extra/clang-tidy/checks/modernize/use-to-underlying.html
...
private:
  ...
  StringRef CustomUnderlyingFunction;
  StringRef CustomUnderlyingHeader;
};
