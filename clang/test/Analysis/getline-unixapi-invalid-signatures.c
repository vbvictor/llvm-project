...
// expected-no-diagnostics
ssize_t getline(char ** restrict lineptr, size_t n, FILE * restrict stream);
...
// expected-no-diagnostics
ssize_t getline(char ** restrict lineptr, size_t * restrict n, int stream);
ssize_t getdelim(char ** restrict lineptr, size_t * restrict n, int delimiter, int stream);
...
// expected-no-diagnostics
ssize_t getdelim(char ** restrict lineptr, size_t * restrict n, const char* delimiter, FILE * restrict stream);
